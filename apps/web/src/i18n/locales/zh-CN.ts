...
export const zhCN: Dict = {
  ...
  // foxpre
  'foxpre.newBidProject': '标书制作',
  'foxpre.bidWarRoom': '投标工作区',
  'foxpre.kanban': '看板',
  'foxpre.documentPreview': '文档预览',
  'foxpre.agentChat': '智能体对话',
  'foxpre.createBid': '创建投标',
  ...
  'foxpre.review': '等待审核',
  'foxpre.needsRevision': '需修改',
  'foxpre.done': '已完成',
  'foxpre.noAgentSelected': '未选择智能体',
  'foxpre.generating': '正在生成...',
  ...
  'foxpre.add': '新增',
  'foxpre.name': '名称',
  'foxpre.noBiddersHint': '暂无可选投标人，请在项目设置中先创建投标主体信息',
  'foxpre.builtin': '内置',
  'foxpre.custom': '自定义',
  'foxpre.bidderName': '公司名称',
  'foxpre.contactPerson': '联系人',
  'foxpre.phone': '联系电话',
  'foxpre.creditCode': '统一社会信用代码',
  'foxpre.legalRep': '法人代表',
  'foxpre.templateName': '模板名称',
  'foxpre.templatePath': '模板路径',
  'foxpre.formatSpec': '格式规范',
  'foxpre.bidNumber': '招标编号',
  'foxpre.description': '描述',
  'foxpre.selectBidder': '选择投标人',
  'foxpre.selectTemplate': '选择模板',
  'foxpre.save': '保存',
  'foxpre.cancel': '取消',
  'foxpre.delete': '删除',
  'foxpre.edit': '编辑',
